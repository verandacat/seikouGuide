...
<div id="wrapper">
  ...
  <header>
    <div class="img-wrap">
      <img src="./img/fv/seikou_topBn_pc-i.png" />
    </div>
  </header>
  ...
  <section id="section-04">
    ...
    <ul class="tabs">
      ...
      <li rel="tab4" onclick="rank_bn.src='./img/ranking/ranking-banner-pc-d.png'">血糖値ケア<br>サプリ</li>
      ...
      <li class="active" rel="tab9" onclick="rank_bn.src='./img/ranking/ranking-banner-pc-i.png'">血糖値ケア<br>サプリ</li>
