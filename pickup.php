        ...
        #pickup-box .pickup-content .pickup-descript {
          ...
          <div id="pickup-box">
            <div class="pickup-title">
                ...
                <h2>
                    <span style="font-weight: normal"><?php echo date('Y'); ?>年<?php echo date('n'); ?>月 </span>
                    おすすめPICK UP アイテム
                </h2>

                <h3 class="pickup-name">
                    <a href="./links/bouhu.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>" rel="noopener" target="_blank" >生漢煎（しょうかんせん）</a>
                </h3>
            </div>
