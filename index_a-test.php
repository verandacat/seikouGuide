...
<div id="wrapper">
  ...
  <header>
    <div class="img-wrap">
      <img src="./img/fv/seikou_topBn_pc-a-test.png?ver=<?php echo time(); ?>" />
    </div>
  </header>
  ...
  <section id="section-01">
    ...
    <div class="title-wrap">
      ...
      <h1 class="center">本当におすすめ！<br>厳選！ダイエタリーライフサポートサプリ5選！</h1>
      ...
      <colgroup width="40%">
              ...
              <tr>
                ...
                <th>
                  ...
                  <p>
                    <span class="lbg">
                      <a target="_blank" href="./links/osaeru.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">オサエル</a>
                    </span>
                  </p>
                </th>
                ...
                <th>
                  ...
                  <p>
                    <span class="lbg">
                      <a target="_blank"
                        href="./links/chuihou.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">脂肪注意報</a>
                    </span>
                  </p>
                </th>
              </tr>
  ...
  <div class="img-wrap">
    <img id="rank_bn" src="./img/ranking/ranking-banner-pc-a-test.png" />
  </div>
