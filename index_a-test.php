...
<div id="wrapper">
    ...
    <section id="section-01">
        ...
        <div class="title-wrap">
            ...
            <h1 class="center">本当におすすめ！<br>厳選！ダイエットサポートサプリランキング<br>ベスト５を大公開！</span></h1>
        ...
        <div class="txt-wrap">
            ...
            <p>当サイトでは数多くのダイエットサポートサプリの成分や利用者の口コミを徹底調査！</p><br>

            <p><span class="bold bg-y">失敗しないダイエットサポートサプリの正しい選び方</span>と<br><span
                    class="bold bg-y">厳選したおすすめのダイエットサポートサプリ</span>をご紹介します。
            </p><br>
        ...
        <table class="table-01" cellspacing="1">
            ...
            <tbody>
                ...
                <tr class="btn" style="height: 50px;">
                    ...
                    <td>
                        <a target="_blank"
                            href="https://xn--eckalq1hua9ak9609eoj6a.com/links/vita.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
                            <img src="./img/n_img/btn_site_go_s.png" width="100%">
                        </a>
    ...
    <div class="last-container">
      ...
      <div class="last-txt bg-wh border-r">
        ...
        <p>当サイトでご紹介しているダイエットサポートサプリは、効果はもちろんですが、
