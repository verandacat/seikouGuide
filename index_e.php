...
<div id="wrapper">
  ...
  <header>
    <div class="img-wrap">
      <img src="./img/fv/seikou_topBn_pc-e.png" />
    </div>
  </header>
  ...
  <div class="img-wrap">
    <img id="rank_bn" src="./img/ranking/ranking-banner-pc-e.png" />
  </div>
  ...
  <section id="section-04">
    ...
    <ul class="tabs">
      ...
      <li class="active" rel="tab5" onclick="rank_bn.src='./img/ranking/ranking-banner-pc-e.png'">酵素<br>サプリ</li>
