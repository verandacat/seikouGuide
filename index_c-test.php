...
<div id="wrapper">
    ...
    <section id="section-01">
        ...
        <div class="txt-wrap">
            ...
            <p><span class="bold bg-y">【失敗しないダイエットサプリの正しい選び方】</span>と<br><span
                    class="bold bg-y">【厳選！おすすめのダイエットサプリ】</span>をご紹介します。
            </p><br>
        ...
        <table class="table-01" cellspacing="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <p>・体内からダイエットを考えたい<br>・体内フローラダイエットに興味がある・詰りの悩みから解放されて、毎朝スッキリしたい</p>
                    </td>
