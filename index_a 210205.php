...
<div id="wrapper">
    ...
    <header>
        <div class="img-wrap">
            <img src="./img/top-banner-pc-new-orange.png?ver=<?php echo time(); ?>" />
        </div>
    </header>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        <p>
                            <a class="link-img" target="_blank"
                                href="https://xn--eckalq1hua9ak9609eoj6a.com/links/lakubi_plus.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                        ...
                        <p>
                            <span style="font-size:13px" class="lbg">
                                <a target="_blank"
                                    href="https://xn--eckalq1hua9ak9609eoj6a.com/links/lakubi_plus.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">Lakubi</a>
                            </span>
                        </p>
                    </th>
