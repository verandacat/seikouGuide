<p>
  <a target="_blank" href="./links/onaka.php<?php echo "?" . $_SERVER['QUERY_STRING']; ?>" target="_blank">
    <span class="f-13">お腹の脂肪が気になる方のためのタブレット</span>
  </a>
</p>　
</th>
</tr>
...
<div class="r-txtbox">
  <p><span class="bold">おなかまわりの体脂肪、ウエストサイズ、体重が気になる</span>方にオススメ！
    配合されている「葛の花由来イソフラボン」は<span class="red">「おなかの脂肪や体重の低減作用」</span>があると研究レビューで報告されています。
    <br><br>
    <span class="red">初回限定で540円（税込）＋送料無料！</span>この値段で30日分なのでかなりお得です！
