        ...
        <div class="r-txtbox">
            ...
            「スリリンダブル」には、<span class="red">臨床試験で脂肪の吸収と糖の吸収を抑える</span>ことが確認されている、
                    ...
                    しかも、今なら先着1000名限定で、<span class="red">メラメラサプリの「スリリンファイヤ」もセットで付いて初回1,628円(税込) </span>！定期購入回数に縛りもなく、60日間の全額返金保証もついており、気軽に試しやすいのがとっても魅力的なところ。
            </p>
        ...
        <table class="r-r-table" cellspacing="1">
            <tbody>
                ...
                <tr>
                    <td>定期初回1,628円 (税込) 定期 3,877円(税込)</td>
                    <td>28粒（1袋）</td>
                    <td>
