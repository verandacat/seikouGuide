...
<div id="wrapper">
    ...
    <h1 class="midashi-05">
        本気でお腹の脂肪を落とすなら効果効能が認められた漢方薬『生漢煎「防風通聖散」』できまり！<br>定期コースで初回50％OFF＋送料無料！＋公式サイトから購入で1,100円OFFクーポン付き！
    </h1>
       ...
       　<h2 class="midashi-h2-03">『生漢煎「防風通聖散」』の口コミ</h2>
        ...
        <div class="text-box">
            ...
            <div class="boxDeco borderBox-green3 greenBox">
                ...
                <p>いろいろなサプリを試したのですが、あまり効果がなくて・・・<br>効果効能が認められている医薬品レベルという生漢煎を見つけて試しに購入してみることにしました。</p>
                <p>まずは1か月以上試してみたいと思ったので、定期コースで購入しました。</p>
                <p>お腹の脂肪を落としてくれる成分が入っているみたいなので、効果も期待できそうです♪</p>
            </div>

            <div class="boxDeco borderBox-green3 greenBox">
                <h4>Q）『生漢煎「防風通聖散」』は買ってよかった？</h4>

                <p>はい！良かったです♪</p>
                <p>持ち運びが簡単で、1回ごとに包装されてるので飲みやすいのが良いですね。<br>
                    外食のときもササッとすぐに飲めるので重宝しています。<br>
                    漢方独特な苦味がありますが、良薬口に苦しということもあり、ありがたく飲んでます。<br>
                    私の中では必須アイテムになっています。<br><br>
                    私の母と妹にも紹介したんですが、とても喜んでくれてました♪<br>父にも飲んでもらおうかと思います。
                </p>
            </div>
        ...
        <div class="review-box boxDeco borderBox-pink3 pinkBox">
            ...
            <!--<div class="review-box boxDeco borderBox-pink3 pinkBox">
                 <div>
                    ...
                    <p>特にお腹周りと顔周りがいいかんじになってきたと満足しています。また他の漢方に比べて甘くて飲みやすいところも良いところです。</p>
                    <p>悪かったことは、値段が高いことです。<br>数ヶ月続けないと効果が出ないと言われているのにこの値段はきついなと思いました。</p>
                </div>
            </div>-->
        </div>
