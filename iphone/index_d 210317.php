<?php include('header.php'); ?>
  ...
  <div id="wrapper">
      ...
      <header>
        ...
        <section id="section-01">
            ...
            <div class="title-wrap center">
                ...
                <h1 class="left"><span class="red">「もっとスッキリしたい！」<br>「糖質を気にせず食べたい！」</span></h1>
            ...
            <div class="txt-wrap">
                ...
                <p>当サイトでは数多くの糖質ケアサプリの成分や利用者の口コミを徹底調査！</p><br>

                <p><span class="bold bg-y">【糖質ケアサプリの正しい選び方】</span>と<br><span class="bold bg-y">【厳選！おすすめの糖質ケアサプリ】</span>をご紹介します。
                </p><br>

                <p>「本気で食習慣を見直したい」とお考えの方は是非参考にしてみてください。</p><br>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th>
                            ...
                            <p>
                              <a class="link-img" target="_blank" href="https://xn--eckalq1hua9ak9609eoj6a.com/links/slilin.php<?php echo "?".$query2; ?>">
                            ...
                            <p>
                              <span class="lbg">
                              <a target="_blank" href="https://xn--eckalq1hua9ak9609eoj6a.com/links/slilin.php<?php echo "?".$query2; ?>">スリリンW</a>
                              </span>
                            </p>
                        ...
                        <tr>
                          ...
                          <td>
                             ...
                             ・脂肪を落としたい<br>・糖質ケアサプリを手軽に試したい<br>・安心の機能性表示食品を試したい
                        ...
                        <tr class="btn" style="height: 50px;">
                          ...
                          <td>
                              <a target="_blank" href="https://xn--eckalq1hua9ak9609eoj6a.com/links/slilin.php<?php echo "?".$query2; ?>">
                                <img src="./img/n_img/btn_site_go_s.png" width="100%">
                              </a>
                          </td>
      ...
      <section id="section-03">
        ...
        <h1 class="midashi">糖質ケアサプリ選びで<br>失敗しないための５つのポイント</h1>
    ...
    <!----------------------------RANKING-------------------------->
        ...
        <div class="swiper-container">
                <ul class="swiper-wrapper tabs">
                  <li class="tab1 swiper-slide"><a href="#tab1" onclick="rank_bn.src='./img/n_img/ranking-banner-sp.png'">総合サプリ<br>ランキング</a></li>
                  <li class="tab2 swiper-slide"><a href="#tab2" onclick="rank_bn.src='./img/n_img/ranking-banner-sp-b.png'">腸内フローラ<br>サプリ</a></li>
                  <li class="tab3 swiper-slide"><a href="#tab3" onclick="rank_bn.src='./img/n_img/ranking-banner-sp-c.png'">体脂肪ケア<br>サプリ</a></li>
                  <li class="tab4 swiper-slide active"><a href="#tab4" onclick="rank_bn.src='./img/n_img/ranking-banner-sp-f.png'">糖質ケア<br>サプリ</a></li>
    ...
    <!----------------------------RANKING-------------------------->
        ...
        <!-- <section id="section-05">
                  ...
                  <div class="last-container">
                    ...
                    <p>当サイトでご紹介している糖質ケアサプリは、効果はもちろんですが、
                            ...
                            <p>試してみようとお考えの方は、<span class="bold red"> お得な特別オファーが終了する前に手に入れてくださいね！</span></p>
