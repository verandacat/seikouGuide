                ...
                <tbody>
                    ...
                    <tr>
                        <th class="r-title" colspan="2">
                            ...
                            <p>
                                <a target="_blank"
                                    href="./links/maarui.php<?php echo "?" . $query2; ?>"
                                    target="_blank">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="r-title" colspan="2">
                            ...
                            <p>
                                <a target="_blank"
                                    href="./links/berunama.php<?php echo "?" . $query2; ?>"
                                    target="_blank">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="r-title" colspan="2">
                            ...
                            <p>
                                <a target="_blank"
                                    href="./links/yoku.php<?php echo "?" . $query2; ?>"
                                    target="_blank">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="r-title" colspan="2">
                            ...
                            <p>
                                <a target="_blank"
                                    href="./links/kon.php<?php echo "?" . $query2; ?>"
                                    target="_blank">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="r-title" colspan="2">
                            ...
                            <p>
                                <a target="_blank"
                                    href="./links/dark.php<?php echo "?" . $query2; ?>"
                                    target="_blank">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="r-title" colspan="2">
                            ...
                            <p>
                                <a target="_blank"
                                    href="./links/beru.php<?php echo "?" . $query2; ?>"
                                    target="_blank">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th class="r-title" colspan="2">
                        ...
                        <p>
                            <a target="_blank" href="./links/yuu.php<?php echo "?" . $query2; ?>" target="_blank">
