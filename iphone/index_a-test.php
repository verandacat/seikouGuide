...
<div id="wrapper">
    ...
    <section id="section-01">
        ...
        <div class="title-wrap center">
            ...
            <h1>本当におすすめ！<br>厳選！ダイエタリーライフサポート<br>サプリランキング<br>ベスト５を大公開！</span></h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        <p>
                            <a class="link-img" target="_blank"
                                href="./links/sibo.php<?php echo $query; ?>">
                        ...
                        <p>
                            <span class="lbg">
                                <a target="_blank"
                                    href="./links/sibo.php<?php echo $query; ?>">シボヘール</a>
                            </span>
                        </p>
                    </th>
                    ...
                    <th>
                        <p>
                            <a class="link-img" target="_blank"
                                href="./links/wild.php<?php echo $query; ?>">
                        ...
                        <p>
                            <span class="lbg">
                                <a target="_blank"
                                    href="./links/wild.php<?php echo $query; ?>">ワイルドマンゴーの力A</a>
                            </span>
                        </p>
                    </th>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="./links/slilinF.php<?php echo $query; ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="./links/slilinF.php<?php echo $query; ?>">スリリンファイア</a>
                        </span>
                    </p>
                </th>
                </tr>
    ...
    <div class="last-container">
      ...
      <div class="last-txt bg-wh border-r">
        ...
        <a target="_blank" href="./links/lakubi_plus.php<?php echo $query; ?>" target="_blank">
