...
<div id="wrapper">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        <p>
                            <a class="link-img" target="_blank"
                                href="https://xn--eckalq1hua9ak9609eoj6a.com/links/lakubi_plus.php<?php echo "?" . $query2; ?>">
                                <img src="./img/lakubi-d.jpg" alt="" width="70" />
                            </a>
                        </p>
                        <p>
                            <span class="lbg">
                                <a target="_blank"
                                    href="https://xn--eckalq1hua9ak9609eoj6a.com/links/lakubi_plus.php<?php echo "?" . $query2; ?>">Lakubi</a>
                            </span>
                        </p>
                    </th>
                    ...
                    <th>
                        <p>
                            <a class="link-img" target="_blank"
                                ...
                                <img src="./img/meta.jpg" alt="" width="70" />
                            </a>
                        </p>
                        <p>
                            <span class="lbg">
    ...
    <div class="img-wrap">
        <img id="rank_bn" src="./img/n_img/ranking-banner-sp.png" width="100%" />
    </div>
