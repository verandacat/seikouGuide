        ...
        <table class="table-01" cellspacing="1">
            ...
            <tbody>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://xn--eckalq1hua9ak9609eoj6a.com/links/slilinF.php<?php echo "?" . $query2; ?>">
                            <img src="./img/slilinF.jpg" alt="" width="70" />
                        </a>
                    </p>
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://xn--eckalq1hua9ak9609eoj6a.com/links/slilinF.php<?php echo "?" . $query2; ?>">スリリンファイア</a>
                        </span>
                    </p>
                </th>
                </tr>
