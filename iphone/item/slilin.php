            ...
            <div class="r-txtbox">
                ...
                <p>
                    ...
                    しかも、今なら先着1000名限定で、<span class="red">メラメラサプリの「スリリンファイヤ」もセットで付いて初回2,678円(税込)</span>！定期購入回数に縛りもなく、60日間の全額返金保証もついており、気軽に試しやすいのがとっても魅力的なところ。
                </p>
            ...
            <table class="r-r-table" cellspacing="1">
                <tbody>
                    ...
                    <tr>
                        <td>定期初回2,678円 (税込) 定期 6,458円(税込)</td>
                        <td>28粒（1袋）</td>
                        <td>
