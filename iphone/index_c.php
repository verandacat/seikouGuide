...
<div id="wrapper">
    ...
    <section id="section-01">
        ...
        <div class="title-wrap center">
            ...
            <h1>本当におすすめ！<br>厳選ダイエタリーライフサポート<br>サプリランキング<br>ベスト３を大公開！</span></h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <p>
                            <span class="lbg">
                                <a target="_blank"
                                    href="./links/wild.php<?php echo "?" . $query2; ?>">ワイルドマンゴーの力A</a>
                            </span>
                        </p>
                    </th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p style="text-align: left">葛の花由来イソフラボン配合</p>
                    </td>
                    <td>
                        <img class="small" src="./img/n_img/r_check_01.png" alt="" />
                        <p>エラグ酸</p>
                ...
                <tr>
                    ...
                    <td>
                        <p style="text-align: left">・お腹の脂肪が気になる<br>・ダイエッターサポートサプリを手軽に試したい<br>・機能性表示食品を試したい</p>
                    </td>
                    ...
                    <td>
                        <p style="text-align:left">・・乳酸菌１億個・活性炭<br>・手ごろな価格で体内フローラサプリを試したい<br>・食べる前に２粒ダケ！脂肪や糖の吸収も抑えたい</p>
                    </td>
                </tr>
