...
<div id="wrapper">
    ...
    <header>
        <div class="img-wrap">
            <img src="./img/top-banner-sp-new-h-test.png" />
        </div>
    </header>
    ...
    <section id="section-01">
        ...
        <div class="txt-wrap">
            ...
            <p>お腹周りの脂肪が気になる<span class="bold bg-y">「肥満症」</span>に効く薬として注目を集めている漢方の医薬品です。
            </p><br>
    ...
    <div class="img-wrap">
        <img id="rank_bn" src="./img/n_img/ranking-banner-sp-h-test.jpg" />
    </div>
