    ...
    <table class="table-01 table-over table-rank6" cellspacing="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank" href="./links/kaitocha.php<?php echo "?" . $query2; ?>">
            ...
            <tr>
                ...
                <td>
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="./links/osaeru.php<?php echo "?" . $query2; ?>">オサエルEX</a>
                        </span>
                    </p>
                </td>
                <td>
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="./links/kaitocha.php<?php echo "?" . $query2; ?>">快糖茶（かいとうちゃ）</a>
                        </span>
                    </p>
                </td>
            </tr>
            ...
            <tr class="btn" style="height: 50px;">
                ...
                <td>
                    <a target="_blank" href="./links/kaitocha.php<?php echo "?" . $query2; ?>">
                        <img src="./img/n_img/btn_site_go_s.png" width="100%">
                    </a>
                </td>
