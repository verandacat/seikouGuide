...
<div id="wrapper">
  ...
  <header>
    <div class="img-wrap">
      <img src="./img/fv/seikou_topBn_pc-d-test2.png" />
    </div>
  </header>
  ...
  <section id="section-01">
    ...
    <div class="title-wrap">
      ...
      <h1 class="center">本当におすすめ！<br>厳選！糖質ケアサプリ6選！</span></h1>
    ...
    <div id="overBox">
      ...
      <table class="table-01 table-over table-rank6" cellspacing="1">
            ...
            <colgroup width="40%">
              <colgroup width="40%">
                ...
                <tr>
                  ...
                  <th style="vertical-align: top">
                    <p>
                      <a class="link-img" target="_blank"
                        href="./links/kaitocha.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
              ...
              <tr>
                ...
                <td>
                  <p>
                    <span class="lbg">
                      <a target="_blank" href="./links/osaeru.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">オサエルEX</a>
                    </span>
                  </p>
                </td>
                <td>
                  <p>
                    <span class="lbg">
                      <a target="_blank"
                        href="./links/kaitocha.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">快糖茶（かいとうちゃ）</a>
                    </span>
                  </p>
                </td>
              </tr>
        ...
        <tr class="btn" style="height: 50px;">
          ...
          <td>
            <a target="_blank" href="./links/kaitocha.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
              <img src="./img/n_img/btn_site_go_s.png" width="100%">
            </a>
          </td>
  ...
  <div class="img-wrap">
    <img id="rank_bn" src="./img/ranking/ranking-banner-pc-d-test2.png" />
  </div>
  ...
  <section id="section-04">
    ...
    <ul class="tabs">
      <li rel="tab1" onclick="rank_bn.src='./img/ranking/ranking-banner-pc-a-test2.png'">総合<br>人気ランキング</li>
      ...
      <li class="active" rel="tab4" onclick="rank_bn.src='./img/ranking/ranking-banner-pc-d-test2.png'">糖質ケア<br>サプリ</li>
