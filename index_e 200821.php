...
<div id="wrapper">
  ...
  <header>
    <div class="img-wrap">
      <img src="./img/top-banner-pc-new-d.png" />
    </div>
  </header>
      ...
      <tbody>
        ...
        <tr>
          ...
          <th>
                ...
                <p>
                  <span class="lbg">
                  <a target="_blank" href="https://xn--eckalq1hua9ak9609eoj6a.com/links/maarui.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">まあるい旬生酵素</a>
                  </span>
                </p>
        ...
        <tr>
          ...
          <td>
            <p>・生の酵素でしっかり栄養を摂りたい<br>・乳酸菌もたっぷり摂りたい<br>・和漢配合で内側から燃焼サポートしたい</p>
          </td>
          ...
          <td>
            <p>・乳酸菌やビフィズス菌など整腸成分も摂りたい<br>・コラーゲン・ヒアルロン酸・プラセンタなどの美容成分も欲しい</p>
          </td>
  ...
  <section id="section-03">
    ...
    <h1 class="midashi">酵素サプリ選びで失敗しないための５つのポイント</h1>
  ...
  <div class="img-wrap">
    <img id="rank_bn" src="./img/n_img/ranking-banner-pc-d.png" />
  </div>
  ...
  <section id="section-04">
    ...
    <ul class="tabs">
      ...
      <li class="active" rel="tab5" onclick="rank_bn.src='./img/n_img/ranking-banner-pc-d.png'">酵素<br>サプリ</li>
