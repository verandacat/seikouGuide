...
<div id="wrapper">
  ...
  <header>
    <div class="img-wrap">
      <img src="./img/fv/seikou_topBn_pc-a.png" />
    </div>
  </header>
  ...
  <section id="section-01">
    ...
    <div class="title-wrap">
      ...
      <h1 class="center">本当におすすめ！<br>厳選！ダイエタリーライフサポートサプリ7選！</h1>
            ...
            <tr>
              ...
              <th>
                ...
                <p>
                  <span class="lbg">
                    <a target="_blank"
                      href="./links/osaeru.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">オサエル</a>
                  </span>
                </p>
              </th>
  ...
  <div class="img-wrap">
    <img id="rank_bn" src="./img/ranking/ranking-banner-pc-a.png" />
  </div>
  ...
  <section id="section-04">
    ...
    <ul class="tabs">
      <li class="active red" rel="tab1" onclick="rank_bn.src='./img/ranking/ranking-banner-pc-a.png'">総合<br>人気ランキング
      </li>
